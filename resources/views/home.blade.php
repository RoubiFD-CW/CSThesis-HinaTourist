...
@section('content')
    ...
    <section id="hero"
        ...
        <div class="absolute inset-0 z-0">
            ...
            <img src="{{ asset('hinatuannewcover.svg') }}" alt="Hinatuan Enchanted River"
        ...
        <div class="relative z-10 text-center max-w-5xl px-4 animate-fade-up">
            <h1
                ...
                <span class="text-cyan-400 bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 to-teal-300"> of
                    Hinatuan</span>
            </h1>
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div
                    class="bg-white rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 group">
                    <div class="relative h-64 overflow-hidden">
                        <img src="{{ asset('HinaTouristImages/lodestone.jpg') }}" alt="Lodgestone Shores Resort"
                            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                        <div
                            class="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-slate-900 shadow-md">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-slate-500 text-sm mb-6 line-clamp-2">Luxury beachfront resort with pristine white
                            sand shores and crystal clear waters perfect for swimming
                            and diving.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-slate-500 text-sm mb-6 line-clamp-2">A stunning oceanside beach offering beautiful
                            sunset views, soft sand, and excellent snorkeling spots.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-12 md:gap-16">
            <div class="flex-1 text-center md:text-left">
                ...
                <p class="text-slate-400 text-lg mb-8 leading-relaxed">
                    Dive into the mesmerizing turquoise depths of the Enchanted River, embark on unforgettable
                    island-hopping adventures through the hidden coves of Portlamon, and discover the thunderous beauty of
            ...
            <div class="flex-1 relative">
                ...
                <div class="relative w-full max-w-md mx-auto">
                    <img src="{{ asset('HinaTouristImages/hinatuanmap.svg') }}" alt="Hinatuan Map"
