...
<body x-data="{ sidebarOpen: false }"
    class="antialiased bg-slate-50 text-slate-800 selection:bg-brand/100 selection:text-white h-screen overflow-y-auto flex flex-col lg:flex-row">
        ...
        <div class="w-full px-0 sm:px-2 pt-0 pb-4 z-20" x-data="dashboard()">
            ...
            <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <div class="divide-y divide-slate-100">
                    <template
                        x-for="log in (typeof paginatedLogs !== 'undefined' ? paginatedLogs : allLogs.slice(0, 5))"
                        :key="log.id || log.local_id">
                ...
                {{-- Pagination Controls --}}
                <div x-show="typeof paginatedLogs !== 'undefined' && allLogs.length > itemsPerPage"
                    class="flex items-center justify-between px-4 py-3 bg-slate-50/50 border-t border-slate-100">
                    <button @click="prevPage()" :disabled="currentPage === 1"
                        class="p-2 rounded-lg hover:bg-slate-200 disabled:opacity-30 disabled:cursor-not-allowed transition-colors">
                        <i class="fa-solid fa-chevron-left text-xs"></i>
                    </button>
                    <span class="text-xs font-medium text-slate-500">
                        Page <span x-text="currentPage" class="text-slate-900"></span> of <span x-text="totalPages"
                            class="text-slate-900"></span>
                    </span>
                ...
                <div x-show="allLogs.length > 0" class="p-3 bg-slate-50 border-t border-slate-100 text-center">
                    <a href="{{ route('logbook.index') }}" class="text-sm text-brand font-medium hover:text-brand">View
                        Full Logbook
                        &rarr;</a>
                </div>
            </div>
            ...
            <div class="mt-8">
                <div class="flex items-center justify-between mb-5">
                    <div>
                        <h2 class="text-lg font-bold text-slate-800 flex items-center gap-2">
                            <i class="fa-solid fa-map-location-dot text-brand"></i> Tourist Destinations
                        </h2>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                    ...
                    {{-- 1. Enchanted River --}}
                    <div class="relative overflow-hidden rounded-2xl shadow-sm border border-slate-200 shadow-sm">
                    ...
                    <div class="group relative overflow-hidden rounded-2xl shadow-sm border border-slate-200 shadow-sm">
                        <div class="relative h-32 overflow-hidden">
                    ...
                    <div class="group relative overflow-hidden rounded-2xl shadow-sm border border-slate-200 shadow-sm">
                        <div class="relative h-32 overflow-hidden">
                            <img src="{{ asset('HinaTouristImages/baculinsandbar.jpg') }}"
                                alt="Baculin Amazing Sand Bar" loading="lazy" class="w-full h-full object-cover">
                        </div>
                        <div class="bg-white p-3">
                    ...
                    <div class="group relative overflow-hidden rounded-2xl shadow-sm border border-slate-200 shadow-sm">
                        <div class="relative h-32 overflow-hidden">
                            <img src="{{ asset('HinaTouristImages/amparitas.jpg') }}"
                                alt="Amparitas Integrated Nature Farm" loading="lazy"
                    ...
                    <div class="group relative overflow-hidden rounded-2xl shadow-sm border border-slate-200 shadow-sm">
                        <div class="relative h-32 overflow-hidden">
                            <img src="{{ asset('HinaTouristImages/landongbay.jpg') }}" alt="Landong Bay" loading="lazy"
                                class="w-full h-full object-cover">
                        </div>
                        <div class="bg-white p-3">
                    ...
                    <div class="group relative overflow-hidden rounded-2xl shadow-sm border border-slate-200 shadow-sm">
                        <div class="relative h-32 overflow-hidden">
                            <img src="{{ asset('HinaTouristImages/bunsadan.png') }}" alt="Bunsadan Falls" loading="lazy"
                                class="w-full h-full object-cover">
                        </div>
                        <div class="bg-white p-3">
                            ...
                            <div class="mb-4" x-data="{
                                ...
                                <div class="relative">
                                    <input type="text" x-model="search" @click="open = true" @focus="open = true"
                                        ...
                                        class="w-full px-4 py-2 rounded-xl border border-slate-200 focus:ring-2 focus:ring-brand/20 focus:border-brand outline-none transition-all text-sm bg-white cursor-text"
                                        autocomplete="off">
                                    ...
                                    <div x-show="open" x-transition.opacity.duration.200ms
                                        ...
                                        <ul class="py-1">
                                            <template x-for="option in filteredOptions" :key="option.value">
                                                <li class="px-4 py-2.5 hover:bg-brand/10 hover:text-brand cursor-pointer text-sm text-slate-700 transition-colors"
                                                    :class="generatorArea === option.value ? 'bg-brand/10 text-brand font-medium' : ''"
